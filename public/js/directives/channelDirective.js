        ...
        link: function(scope, element, attrs) {
          d3Service.d3().then(function(d3) {
            ...
            var chartBars = function (sortbyDate) {
              // var sortbyDate = d3.values(data).sort(function(a, b) { return new Date(a.date) - new Date(b.date); });
              ...
              yScale.domain([0, d3.max(d3.values(sortbyDate), function (d) { return d.total; })]);
