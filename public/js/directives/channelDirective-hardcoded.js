...
var svg = d3.select("#chart").append("svg")
  ...
  console.log(d3.values(data).map(function (d) {
    return d
  }));
  ...
  data.forEach(function(d) {
    var y0 = 0;
    d.ages = color.domain().map(function(name) {console.log(name); return {name: name, y0: y0, y1: y0 += +d[name]}; });
  ...
  date.selectAll("rect")
      .data(function(d) {console.log(d); return d.ages; })
    .enter().append("rect")
